...
承認担当者:「勤怠レポート」をクリックしてください。→勤怠、休暇、残業についてのデータをCSVでダウンロードしたり、印刷することができます。
※一般社員では、「勤怠レポート」を確認できない点は、気を付けてください。
...
一般社員：「プロフィール設定」をクリックしてください。→基本情報で、「社員ID」や「ロール」以外は、変更できます。
...
システム管理者：管理者メニューの中で、「ユーザー管理」をクリックしてください。→新規一般社員のユーザーのアカウントを作ることができます。
