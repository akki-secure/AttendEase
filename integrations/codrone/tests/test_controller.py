...
def make_controller() -> Controller:
    ...
    controller.drone.power_pressed.return_value = False
    controller.drone.left_arrow_pressed.return_value = False
    controller.drone.right_arrow_pressed.return_value = False
    controller._power_pressed_since = None
    controller._power_long_press_fired = False
    controller._prev_left = False
    controller._prev_right = False
    return controller


def set_power(controller: Controller, pressed: bool) -> None:
    controller.drone.power_pressed.return_value = pressed
...
def test_power_takes_priority_over_mode(monkeypatch):
    controller = make_controller()
    t = [0.0]
    monkeypatch.setattr("controller.time.monotonic", lambda: t[0])
